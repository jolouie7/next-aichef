...
export default function MealPage() {
  ...
  const imageUrl = "/aichef-logo.png"; // replace with the actual image URL
  const tempMeal = { ...meal, imageUrl }; // add imageUrl to the meal object
  ...
  //       toast({
  //         title: "Error",
  //         description: "Error fetching meal",
  //         variant: "destructive",
  //       });
  //       setLoading(false);
  //     }
